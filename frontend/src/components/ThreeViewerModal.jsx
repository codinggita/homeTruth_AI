      ...
      {isOpen && (
        ...
        >
          <div className="relative w-full h-full">
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 z-[210] p-3 bg-white/10 hover:bg-critical/80 backdrop-blur-md rounded-full text-white transition-colors border border-white/20 shadow-2xl group"
            >
            ...
            {/* Title Overlay */}
            {(title || address) && (
              <div className="absolute top-6 left-6 z-[210] bg-black/50 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/10 shadow-2xl">
